...
#define ORIGINAL_FILE_NAME "UE4Editor-AudiokineticTools.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME BulletRealm
#define DEPRECATED_FORGAME DEPRECATED
#define AUDIOKINETICTOOLS_API DLLEXPORT
#define USE_AKAUDIO 1
#define AK_UNREAL_MAX_CONCURRENT_IO 256
#define AK_UNREAL_IO_GRANULARITY 32768
#define AK_SOUNDFRAME 1
