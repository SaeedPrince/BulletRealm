...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFMovieSceneAkAudioRTPCTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCTemplate()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MovieSceneAkAudioRTPCTemplate"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FMovieSceneAkAudioRTPCTemplate>, EStructFlags(0x00000205));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneAkAudioRTPCTemplate_CRC() { return 1172775665U; }
