...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFMovieSceneAkAudioEventTemplate
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMovieSceneAkAudioEventTemplate()
	{
		...
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("MovieSceneAkAudioEventTemplate"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FMovieSceneAkAudioEventTemplate>, EStructFlags(0x00000205));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMovieSceneAkAudioEventTemplate_CRC() { return 3719423247U; }
